...
void LevelEditor::init() {
	...
	demon->engine.add_event_hook( "mouse1",    [this](std::vector<void*>& params) { this->on_mouse();    }, {} );
	demon->engine.add_event_hook( "mouse1-up", [this](std::vector<void*>& params) { this->on_mouse_up(); }, {} );
}
